...
public class DSLApplication extends Application<DSLConfiguration> {

    public void run(DSLConfiguration DSLConfiguration, Environment environment) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        new DSLApplication().run(args);
    }

    private HibernateBundle<DSLConfiguration> hibernate;

    @Override
    public void initialize(Bootstrap<DSLConfiguration> bootstrap) {
    ...
    private static SubstitutingSourceProvider newConfigurationSourceProvider(Bootstrap<DSLConfiguration> bootstrap) {
        return new SubstitutingSourceProvider(bootstrap.getConfigurationSourceProvider(),
                new EnvironmentVariableSubstitutor(false));
    }

    private static HibernateBundle<DSLConfiguration> newHibernateBundle() {
        return new ScanningHibernateBundle<DSLConfiguration>("com.dsl.core") {

            public DataSourceFactory getDataSourceFactory(DSLConfiguration configuration) {
